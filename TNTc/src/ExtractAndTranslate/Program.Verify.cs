...
public partial class Program
{
    ...
    public static void Verify(string rootFolderPath, string? languageCodes, bool strict)
    {
        ...
        Console.WriteLine($"{"lang",-6}{"total",8}{"pending",9}{"unused",8}{"errors",8}{"warnings",10}");
        ...
        foreach (var language in languages)
        {
            ...
            if (!File.Exists(path))
            {
                Console.WriteLine($"{LanguageHelper.MapLanguage(language),-6}{"- no translation file -",43}");
                continue;
            }
            ...
            Console.WriteLine($"{LanguageHelper.MapLanguage(language),-6}{records.Count,8}{pending,9}{unused,8}{languageErrors.Count,8}{languageWarnings.Count,10}");
